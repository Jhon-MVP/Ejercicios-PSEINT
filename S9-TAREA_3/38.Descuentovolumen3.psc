Proceso calcularDescuentoVolumen
	...
	Si cantidad > 100 Entonces
		precioTotal <- cantidad * precioUnitario * 0.85;
		Escribir "¡Felicidades! Usted califica para un descuento del 15% por volumen de compra.";
		Escribir "El precio total con descuento es: $", precioTotal;
	Sino Si cantidad >= 51 Entonces
